...
<svelte:head>
	<title>{data.product.name} | TPG</title>
...
<div class="grow flex flex-col sm:pt-10 w-full">
	...
	<div class="h-full sm:mx-10 mx-4 sm:grid sm:grid-cols-4 flex flex-col">
		...
		<div class="sm:p-4 py-6 flex flex-col gap-4 sm:h-[85vh] sm:overflow-scroll no-scroll">
			...
			<div class="text-lg text-gray-500 font-light">
				Order now and get an exclusive item for free as part of our launch event!
			</div>
		</div>
	</div>
	...
	<blockquote
		...
		data-instgrm-permalink="https://www.instagram.com/thatll_play_golf/?utm_source=ig_embed&amp;utm_campaign=loading"
	...
	>
		<div style="padding:16px;">
			<a
				href="https://www.instagram.com/thatll_play_golf/?utm_source=ig_embed&amp;utm_campaign=loading"
			...
			>
				<a
					...
					target="_blank">That'll Play Golf</a
				>
				(@<a
					href="https://www.instagram.com/thatll_play_golf/?utm_source=ig_embed&amp;utm_campaign=loading"
					style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px;"
					target="_blank">thatll_play_golf</a
